var SenecaioBusinessCard = function(el, radius){
  ...
  const logoWidthInCells = 5;
  const logoHeightInCells = 5;
  ...
  var grid = new HexGrid(radius, w, h - logoHeightInCells + 1);
  this.maze = new HexMaze(grid, grid.getCell(0,0), grid.getCell(grid.width-1, grid.height-1));

  var bottomGrid = new HexGrid(radius, w - logoWidthInCells, logoHeightInCells);
